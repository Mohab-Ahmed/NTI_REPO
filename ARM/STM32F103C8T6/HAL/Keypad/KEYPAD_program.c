...
u8 KEYPAD_u8GetKey(void)
{
	...
	GPIO_voidSetPinValue(KEYPAD_ROW_1_PIN, GPIO_ENUM_HIGH);
	GPIO_voidSetPinValue(KEYPAD_ROW_2_PIN, GPIO_ENUM_HIGH);
	GPIO_voidSetPinValue(KEYPAD_ROW_3_PIN, GPIO_ENUM_HIGH);
	GPIO_voidSetPinValue(KEYPAD_ROW_4_PIN, GPIO_ENUM_HIGH);

	/* ROW 1 check all COLUMNS */
	GPIO_voidSetPinValue(KEYPAD_ROW_1_PIN, GPIO_ENUM_LOW);
	if (!GPIO_u8GetPinValue(KEYPAD_COL_1_PIN))
	{
		Local_u8Key=KEYPAD_Au8keys[0][0];
		while(GPIO_u8GetPinValue(KEYPAD_COL_1_PIN));
	}
	else if (!GPIO_u8GetPinValue(KEYPAD_COL_2_PIN))
	{
		Local_u8Key=KEYPAD_Au8keys[0][1];
		while(GPIO_u8GetPinValue(KEYPAD_COL_2_PIN));
	}
	else if (!GPIO_u8GetPinValue(KEYPAD_COL_3_PIN))
	{
		Local_u8Key=KEYPAD_Au8keys[0][2];
		while(GPIO_u8GetPinValue(KEYPAD_COL_3_PIN));
	}
	else if (!GPIO_u8GetPinValue(KEYPAD_COL_4_PIN))
	{
		Local_u8Key=KEYPAD_Au8keys[0][3];
		while(GPIO_u8GetPinValue(KEYPAD_COL_4_PIN));
	}
	GPIO_voidSetPinValue(KEYPAD_ROW_1_PIN, GPIO_ENUM_HIGH);


	/* ROW 2 check all COLUMNS */
	GPIO_voidSetPinValue(KEYPAD_ROW_2_PIN, GPIO_ENUM_LOW);
	if (!GPIO_u8GetPinValue(KEYPAD_COL_1_PIN))
	{
	...
	GPIO_voidSetPinValue(KEYPAD_ROW_3_PIN, GPIO_ENUM_LOW);
	if (!GPIO_u8GetPinValue(KEYPAD_COL_1_PIN))
	{
	...
	GPIO_voidSetPinValue(KEYPAD_ROW_4_PIN, GPIO_ENUM_LOW);
	if (!GPIO_u8GetPinValue(KEYPAD_COL_1_PIN))
	{
